...
public interface IBuildPackages : IHazMainProject, IHazExample, IRelease, ISign, IGitRelease, IHazPack, IHazContent
{
    Target BuildPackages => _ => _
        ...
        .Executes(() =>
        {
            ...
            {
                var project = Solution.GetOtherProject(projectName);
